...
int main() {
    ...
    string originalText = generateRandomString(10);
  
    string cipher = encryption(originalText, key);
    ...
    decryptedMessage = decryption(key, cipher); 
    //find the decrypted for comparison

    //cout << "This is the decryptedMessage: " << decryptedMessage << "\n";
    ...
    //encryptionMain(originalText, key);
